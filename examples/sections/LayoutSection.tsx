...
export function LayoutSection() {
  return (
    <GallerySection
      id="layout"
      title="Layout"
      description="Box, Stack, Grid, Sidebar and Resizable panels"
    >
      <div className="example-stack-4">
        ...
        <div className="example-grid">
          ...
          <Box
            component="section"
            style={{ padding: '1rem', border: '1px solid var(--color-border)', borderRadius: 8 }}
          >
        ...
        <div className="example-grid">
          <div>
            <p className="example-text-xs-muted" style={{ marginBottom: '0.5rem' }}>
              Column (default)
            </p>
            <Stack spacing={2}>
          ...
          <div>
            ...
            <Stack spacing={2} divider={<Separator />}>
              {['First', 'Second', 'Third'].map((label) => (
                <Box key={label} style={{ fontSize: '0.875rem' }}>
                  {label}
                </Box>
              ))}
            </Stack>
        ...
        <div className="example-stack-4">
          {/* Horizontal sizes */}
          <div>
            <p className="example-text-xs-muted" style={{ marginBottom: '0.75rem' }}>
              Horizontal — sizes
            </p>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <Divider textAlign="right" size="sm">
                End
              </Divider>
            </div>
          </div>
