...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div data-slot="table-wrapper">
      <table data-slot="table" ref={ref} className={cn(className)} {...props} />
    </div>
  )
)
...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} data-slot="table-footer" className={cn(className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <caption ref={ref} data-slot="table-caption" className={cn(className)} {...props} />
))
